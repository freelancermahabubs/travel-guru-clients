        ...
        <div className="flex gap-6 flex-col md:flex-row justify-between items-center md:gap-12">
          ...
          >
            ...
            <li>
              <Link
                to="/destination"
                className={`text-${textColor} text-lg font-medium`}
              >
                Destination
              </Link>
            </li>
            ...
            <li>
              {user ? (
                <div className="flex items-center gap-2">
                  <p
                    className={`font-semibold hidden md:block text-${textColor}`}
                  >
                    {userName}
                  </p>
                  <button
                    onClick={logOut}
                    className="bg-yellow-500  text-slate-800 px-8 py-2 rounded-lg font-semibold  "
                  >
                    Log Out
                  </button>
                </div>
                ...
                <Link to="/login">
                  <button className="bg-yellow-500 text-xl text-slate-800 px-6  rounded-md">
                    Login
                  </button>
                </Link>
              )}
